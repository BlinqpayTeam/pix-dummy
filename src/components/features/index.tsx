...
const Features = () => {
  return (
      <div className='text-center text-white pt-52 overflow-hidden'>
          ...
          <div className="flex justify-center items-center mb-20 mt-40 relative bg-[url('/images/feature.svg')] h-[520px] bg-no-repeat bg-center bg-cover lg:bg-contain">
