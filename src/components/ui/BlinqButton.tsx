...
const BlinqButton = ({
	...
	return (
		...
		<button
			...
			className={`${extraPadding ? 'px-6' : 'px-3'} py-2.5 flex items-center justify-center whitespace-nowrap rounded-[6px] font-medium font-creato text-[12px] md:t4 tracking-wide active:scale-90 transition-all durationn-300 disabled:bg-opacity-70 
